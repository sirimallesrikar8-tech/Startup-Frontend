        ...
        const sampleVenues = [
            {
                ...
                location: "Downtown City Center, Mumbai",
                fullAddress: "123 Event Street, Downtown City Center, Mumbai 400001, Maharashtra, India",
                rating: 4.8,
                reviews: 245,
                capacity: "500 Guests",
                ...
                minAdvanceBooking: 3,
                timeSlots: [
                    { id: "1", time: "09:00 AM - 12:00 PM", basePrice: 15000 },
                    { id: "2", time: "01:00 PM - 04:00 PM", basePrice: 18000 },
                    { id: "3", time: "06:00 PM - 10:00 PM", basePrice: 25000 },
                    { id: "4", time: "11:00 PM - 03:00 AM", basePrice: 20000 },
                ]
            },
            {
                id: "royal-garden-banquet",
                name: "Royal Garden Banquet",
                location: "Bandra West, Mumbai",
                fullAddress: "456 Garden Lane, Bandra West, Mumbai 400050, Maharashtra, India",
                rating: 4.6,
                reviews: 189,
                capacity: "300 Guests",
                description: "An elegant outdoor banquet with beautiful garden settings.",
                amenities: ["Outdoor", "Parking", "Catering", "DJ", "Lighting"],
                category: "Venue",
                priceRange: { min: 20000, max: 60000 },
                cancellationPolicy: "Free cancellation up to 72 hours before the event",
                minAdvanceBooking: 5,
                timeSlots: [
                    { id: "1", time: "10:00 AM - 02:00 PM", basePrice: 20000 },
                    { id: "2", time: "03:00 PM - 07:00 PM", basePrice: 25000 },
                    { id: "3", time: "07:00 PM - 11:00 PM", basePrice: 35000 },
                ]
            },
            {
                ...
                fullAddress: "789 Studio Street, Andheri East, Mumbai 400069, Maharashtra, India",
                rating: 4.9,
                reviews: 312,
                capacity: "Any size",
                ...
                timeSlots: [
                    ...
                    { id: "3", time: "Hourly (Per Hour)", basePrice: 8000 },
                ]
            }
        ]
